...
def generate_mxbai_embed_large(text, emb_path, task_description):
    """
    Generate embeddings using mxbai-embed-large-v1 model.
    ...
    BATCH_SIZE = 64
    max_length = 512  # This model supports long sequences
...
EMBEDDING_DIM = {
    ...
    'mixedbread-ai/mxbai-embed-large-v1': 1024  # New model added
}
...
def generate_embeddings_and_save(args):
    ...
    elif args.lm_model_name == 'mixedbread-ai/mxbai-embed-large-v1':  # Add new model here
        generate_mxbai_embed_large(text, emb_path, task_description)
    else:
